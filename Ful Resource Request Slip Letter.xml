...
<xsl:template match="/">
	<html>
		...
		<xsl:call-template name="generalStyle" />
			...
			<body>
			<h2>
                <strong>@@requested_for@@ : </strong><xsl:value-of select="notification_data/user_for_printing/name"/>
			</h2>
			...
			<div class="messageArea">
				<div class="messageBody">
					 <table role='presentation'  cellspacing="0" cellpadding="5" border="0">
						...
						<tr>
							<td><h2><strong>@@move_to_library@@: </strong><xsl:value-of select="notification_data/destination"/></h2></td>
						</tr>
						<tr>
